    ...
    public function testDeserialize(): void
    {
        self::assertDeserialize(
            ...
            function (Image $result) {
                self::assertEquals(
                    "https://cdn.stocksnap.io/img-thumbs/960w/fruit-slices_NNIRPAXZFX.jpg",
                    $result->getUrl()
                );
                self::assertEquals(493289770, $result->getId());
                self::assertEquals(
                    "ab665923-d288-45ff-8d9e-410d10dda01e/40986800/100/493289770.png",
                    $result->getThumbPathExt()
                );
                self::assertEquals(
                    "https://cdn.stocksnap.io/img-thumbs/960w/fruit-slices_NNIRPAXZFX.jpg",
                    $result->getThumbUrl()
